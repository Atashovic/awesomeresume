...
//    public User(int id, String name, String surname, String phone, String email, String profileDesc, Date birthDate, Country nationality, Country birthPlace, List<UserSkill> skills) {
//        this.id = id;
//        this.name = name;
//        this.surname = surname;
//        this.phone = phone;
